...
# how to get ank-agent could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/ank-agent/0.4.0-pre"
...
include ank-agent-${PV}.inc
include ank-agent.inc
